...
export const KPI_DESCRIPTIONS: Record<string, string> = {
  ...
  treatment_success_rate: 'Share of this agent\'s attributed treatment outcomes that were a clinical success (vs complication/revision/failure).',
...
export const KPI_UNITS: Record<string, KpiUnit> = {
  ...
  treatment_success_rate: 'percent',
